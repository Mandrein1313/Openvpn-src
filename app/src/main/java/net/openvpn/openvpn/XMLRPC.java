...
public class XMLRPC {
    ...
    public static class XMLRPCFault extends XMLRPCException {
        ...
        public XMLRPCFault(String faultString, int faultCode) {
            super("XMLRPC Fault: " + faultString +
                    " [code " + faultCode + "]");
    ...
    public static Object parse_response(XmlPullParser pullParser)
            throws XmlPullParserException, XMLRPCException, IOException {
        ...
        if (tag.equals("params")) {
            ...
            Map<String,Object> map =
                    (Map<String,Object>) deserialize(pullParser);


            throw new XMLRPCFault(
                    (String) map.get("faultString"),
                    ((Integer) map.get("faultCode"))
            );
    ...
    public static void serialize(XmlSerializer serializer, Object object)
            throws IOException {
        ...
        if (object instanceof Integer ||
            ...
            serializer.startTag(null, TYPE_I4)
            ...
            serializer.startTag(null, TYPE_I8)
                    .text(object.toString())
                    .endTag(null, TYPE_I8);
            ...
            serializer.startTag(null, TYPE_DOUBLE)
                    .text(object.toString())
            ...
            serializer.startTag(null, TYPE_DATE_TIME_ISO8601)
                    .text(dateFormat.format(object))
            ...
            serializer.startTag(null, TYPE_BASE64)
                    .text(Base64.encodeToString((byte[])object, 2))
            ...
            serialize(serializer,
                    ((Serializable)object).getSerializable());
    ...
    public static Object deserialize(XmlPullParser parser)
        ...
        if(typeNodeName.equals(TYPE_INT)
            ...
            obj=Integer.parseInt(parser.nextText());


        }else if(typeNodeName.equals(TYPE_I8)){


            obj=Long.parseLong(parser.nextText());


        }else if(typeNodeName.equals(TYPE_DOUBLE)){


            obj=Double.parseDouble(parser.nextText());


        }else if(typeNodeName.equals(TYPE_BOOLEAN)){


            obj=parser.nextText().equals("1");
            ...
            try{
                ...
                obj=dateFormat.parse(parser.nextText());
            ...
            BufferedReader reader =
                    new BufferedReader(
                            new StringReader(parser.nextText()));
            ...
            throw new IOException(
                    "Cannot deserialize "+parser.getName());
        }
